...
<footer class="footer">
    <div class="footer-top container">
        ...
        <div class="footer-col">
            ...
            <button class="footer-link" type="button" onclick={() => authModal.openRegister('Employee')}>{$t('footer.postJobs')}</button>
        ...
        <div class="footer-col footer-col--side">
            ...
            <div class="social-row">
                    <a href={links.telegram} class="social-link" target="_blank" rel="noopener" aria-label="Telegram" title="Telegram">
                    ...
                    <a href={links.vk} class="social-link" target="_blank" rel="noopener" aria-label="VK" title="ВКонтакте">
                        <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M15.684 0H8.316C1.592 0 0 1.592 0 8.316v7.368C0 22.408 1.592 24 8.316 24h7.368C22.408 24 24 22.408 24 15.684V8.316C24 1.592 22.391 0 15.684 0zm3.692 17.123h-1.744c-.66 0-.864-.525-2.05-1.727-1.033-1-1.49-1.135-1.744-1.135-.356 0-.458.102-.458.593v1.575c0 .424-.135.678-1.253.678-1.846 0-3.896-1.118-5.335-3.202C4.624 10.857 4.03 8.57 4.03 8.096c0-.254.102-.491.593-.491h1.744c.44 0 .61.203.78.678.863 2.49 2.303 4.675 2.896 4.675.22 0 .322-.102.322-.66V9.721c-.068-1.186-.695-1.287-.695-1.71 0-.204.17-.407.44-.407h2.744c.373 0 .508.203.508.644v3.473c0 .372.17.508.271.508.22 0 .407-.136.813-.542 1.253-1.406 2.149-3.574 2.149-3.574.119-.254.322-.491.763-.491h1.744c.525 0 .644.27.525.644-.22 1.017-2.354 4.031-2.354 4.031-.186.305-.254.44 0 .78.186.254.796.779 1.203 1.253.745.847 1.32 1.558 1.473 2.05.17.49-.085.744-.576.744z"/></svg>
                    </a>
                    <a href={links.dzen} class="social-link" target="_blank" rel="noopener" aria-label="Дзен" title="Дзен">
                        <svg viewBox="0 0 28 28" width="20" height="20" fill="currentColor" fill-rule="evenodd"><path d="M16.7 16.7c-2.2 2.27-2.36 5.1-2.55 11.3 5.78 0 9.77-.02 11.83-2.02 2-2.06 2.02-6.24 2.02-11.83-6.2.2-9.03.35-11.3 2.55M0 14.15c0 5.59.02 9.77 2.02 11.83 2.06 2 6.05 2.02 11.83 2.02-.2-6.2-.35-9.03-2.55-11.3-2.27-2.2-5.1-2.36-11.3-2.55M13.85 0C8.08 0 4.08.02 2.02 2.02.02 4.08 0 8.26 0 13.85c6.2-.2 9.03-.35 11.3-2.55 2.2-2.27 2.36-5.1 2.55-11.3m2.85 11.3C14.5 9.03 14.34 6.2 14.15 0c5.78 0 9.77.02 11.83 2.02 2 2.06 2.02 6.24 2.02 11.83-6.2-.2-9.03-.35-11.3-2.55"/></svg>
                    </a>
                    <a href={links.max} class="social-link" target="_blank" rel="noopener" aria-label="Max" title="Max">
                        <svg viewBox="100 100 800 800" width="20" height="20" fill="currentColor"><path fill-rule="evenodd" d="M508.211 878.328c-75.007 0-109.864-10.95-170.453-54.75-38.325 49.275-159.686 87.783-164.979 21.9 0-49.456-10.95-91.248-23.36-136.873-14.782-56.21-31.572-118.807-31.572-209.508 0-216.626 177.754-379.597 388.357-379.597 210.785 0 375.947 171.001 375.947 381.604.707 207.346-166.595 376.118-373.94 377.224m3.103-571.585c-102.564-5.292-182.499 65.7-200.201 177.024-14.6 92.162 11.315 204.398 33.397 210.238 10.585 2.555 37.23-18.98 53.837-35.587a189.8 189.8 0 0 0 92.71 33.032c106.273 5.112 197.08-75.794 204.215-181.95 4.154-106.382-77.67-196.486-183.958-202.574Z" clip-rule="evenodd"/></svg>
                    </a>
            </div>

            <h3 class="footer-heading" style="margin-top: var(--space-4)">{$t('footer.notifBots')}</h3>
            <div class="bot-row">
                <button class="bot-link" onclick={notifyBotUnavailable} type="button" title="Telegram-бот">
                ...
                <button class="bot-link" onclick={notifyBotUnavailable} type="button" title="VK-бот">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M15.684 0H8.316C1.592 0 0 1.592 0 8.316v7.368C0 22.408 1.592 24 8.316 24h7.368C22.408 24 24 22.408 24 15.684V8.316C24 1.592 22.391 0 15.684 0zm3.692 17.123h-1.744c-.66 0-.864-.525-2.05-1.727-1.033-1-1.49-1.135-1.744-1.135-.356 0-.458.102-.458.593v1.575c0 .424-.135.678-1.253.678-1.846 0-3.896-1.118-5.335-3.202C4.624 10.857 4.03 8.57 4.03 8.096c0-.254.102-.491.593-.491h1.744c.44 0 .61.203.78.678.863 2.49 2.303 4.675 2.896 4.675.22 0 .322-.102.322-.66V9.721c-.068-1.186-.695-1.287-.695-1.71 0-.204.17-.407.44-.407h2.744c.373 0 .508.203.508.644v3.473c0 .372.17.508.271.508.22 0 .407-.136.813-.542 1.253-1.406 2.149-3.574 2.149-3.574.119-.254.322-.491.763-.491h1.744c.525 0 .644.27.525.644-.22 1.017-2.354 4.031-2.354 4.031-.186.305-.254.44 0 .78.186.254.796.779 1.203 1.253.745.847 1.32 1.558 1.473 2.05.17.49-.085.744-.576.744z"/></svg>
                    VK
                </button>
                <button class="bot-link" onclick={notifyBotUnavailable} type="button" title="Max-бот">
                    <svg viewBox="100 100 800 800" width="16" height="16" fill="currentColor"><path fill-rule="evenodd" d="M508.211 878.328c-75.007 0-109.864-10.95-170.453-54.75-38.325 49.275-159.686 87.783-164.979 21.9 0-49.456-10.95-91.248-23.36-136.873-14.782-56.21-31.572-118.807-31.572-209.508 0-216.626 177.754-379.597 388.357-379.597 210.785 0 375.947 171.001 375.947 381.604.707 207.346-166.595 376.118-373.94 377.224m3.103-571.585c-102.564-5.292-182.499 65.7-200.201 177.024-14.6 92.162 11.315 204.398 33.397 210.238 10.585 2.555 37.23-18.98 53.837-35.587a189.8 189.8 0 0 0 92.71 33.032c106.273 5.112 197.08-75.794 204.215-181.95 4.154-106.382-77.67-196.486-183.958-202.574Z" clip-rule="evenodd"/></svg>
                    Max
                </button>
            </div>
            ...
            {#if mobileAppLink}
                <div class="qr-section">
                    ...
                    <div class="qr-placeholder">
                        <a href="/mobile-app">
                            {#if qrDataUrl}
                                <img src={qrDataUrl} alt={$t('footer.qrAlt')} width="100" height="100" />
                            {/if}
                        </a>
                    </div>
                </div>
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-inner container">
            <div class="locale-picker">
                <button class="locale-btn" onclick={() => (localeOpen = !localeOpen)} type="button" aria-expanded={localeOpen}>
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>
                ...
                {#if localeOpen}
                    <div class="locale-dropdown">
                        {#each LOCALES as loc (loc.id)}
                            <button class="locale-option" class:active={$locale === loc.id} type="button" onclick={() => { locale.set(loc.id); localeOpen = false; }}>
