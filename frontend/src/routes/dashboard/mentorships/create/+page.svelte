    ...
    <div class="create-layout">
        <div class="form-col">
            <section class="form-section">
                <Input
                    label={$t('createMentorship.nameLabel')}
                    bind:value={title}
                    placeholder={$t('createMentorship.namePlaceholder')}
                    error={errors.title}
            ...
            <section class="form-section">
                <Select
                    ...
                    bind:value={format}
                    label={$t('createMentorship.format')}
                />
            </section>

            <section class="form-section">
                <MarkdownEditor
                    label={$t('createMentorship.descLabel')}
                    bind:value={description}
                    placeholder={$t('createMentorship.descPlaceholder')}
            ...
            <section class="form-section">
                ...
                <Input
                    ...
                    placeholder={$t('createMentorship.maxParticipantsPlaceholder')}
                />
            </section>
            ...
            <section class="form-section">
                <div class="form-row">
                    ...
                    />
                    <Input
                        label={$t('createMentorship.salaryTo')}
                        type="number"
                        bind:value={salaryTo}
                        placeholder="0"
                    />
            ...
            <section class="form-section">
                <div class="form-row">
                    <Input
                        label={$t('createMentorship.city')}
                        bind:value={city}
                        placeholder={$t('createMentorship.cityPlaceholder')}
                        error={errors.city}
                        onblur={validateCity}
                        oninput={() => clearError('city')}
                    />
                    <Input
                        label={$t('createMentorship.country')}
                        bind:value={country}
                        placeholder={$t('createMentorship.countryPlaceholder')}
                    />
                </div>
                {#if format !== 'Remote'}
                    <Input
                        label={$t('createMentorship.address')}
                        bind:value={address}
                        placeholder={$t('createMentorship.addressPlaceholder')}
                ...
                <div class="tags-edit">
                    ...
                    >
                        <div class="tag-input-wrap">
                            <Input
                                placeholder={$t('createMentorship.tagsPlaceholder')}
                                bind:value={newTag}
                            />
            ...
            <div class="form-actions">
                <Button size="lg" onclick={publish} disabled={submitting}
                    >{submitting ? $t('common.loading') : $t('createMentorship.publish')}</Button
                >
                <Button size="lg" variant="outline" onclick={saveDraft} disabled={submitting}
                    >{$t('createMentorship.saveDraft')}</Button
                >
            </div>
        </div>
            ...
            <div class="preview-card">
                ...
                {#if computedDuration}
                    <p class="preview-duration">
                        {$t('createMentorship.durationLabel')}: {computedDuration}
                    </p>
                {/if}
                {#if maxParticipants}
                    <p class="preview-participants">
                        {$t('createMentorship.participantsLabel')}: {maxParticipants}
                    </p>
                {/if}
                {#if startDate}
                ...
                <p class="preview-location">
                    {city || $t('createMentorship.cityPlaceholder')}{address ? `, ${address}` : ''}
                </p>
                {#if tags.length > 0}
