<script lang="ts">
        ...
        let companies = $state<{ id: string; name: string; activity: string; isVerified: boolean; verificationLevel: number; jobCount: number; link: string | null }[]>([]);
        ...
        let filtered = $derived.by(() => {
                ...
                if (search) {
                        ...
                        list = list.filter((c) => c.name.toLowerCase().includes(q) || c.activity.toLowerCase().includes(q));
                }
                if (activityFilter) {
                        const activityMap: Record<string, string> = {
                                dev: $t('companies.fieldSoftware'), fintech: $t('companies.fieldFintech'), gamedev: $t('companies.fieldGamedev'),
                                ai: $t('companies.fieldAI'), security: $t('companies.fieldCyber'), cloud: $t('companies.fieldCloud'), edtech: $t('companies.fieldEdtech')
                        };
...
<div class="companies-page container--wide">
        <div class="page-header">
                ...
                <div class="page-controls">
                        ...
                        <Select options={activityOptions} bind:value={activityFilter} placeholder={$t('common.industry')} />
                </div>
        </div>
