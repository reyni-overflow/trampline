...
public class Job
{
    ...
    public JobType Type { get; private set; } = JobType.Work;

    public Guid EmployeeId { get; private set; }

    public Guid UserId { get; private set; }

    public EmployeeProfile Employee { get; private set; } = null!;
    ...
    public static Job Create(Guid employeeId, Guid userId, string title, string description, JobType type, WorkFormat format)
    {
        return new Job()
        {
            Id = Guid.NewGuid(),
